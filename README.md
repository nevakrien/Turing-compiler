...
3. tmc0: (not yet tested) would compile a .t file into a binary when its done
...
## compiler
1. add proper testing (for outoftape and timeout/infinite loop)
2. add a way to benchmark old+new version of the compiler to asses changes
3. uninline the expand functions
